...
const About = () => {
  ...
  const certifications = ['Ingeniera de Alimentos', 'Registro ICA para control de plagas', 'Certificación en sistemas HACCP', 'Concepto favorable secretaria salud del gobierno de Casanare'];
